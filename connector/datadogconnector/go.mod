...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/statsprocessor v0.66.1
	...
	go.opentelemetry.io/collector/connector/connectortest v0.128.1-0.20250610090210-188191247685
